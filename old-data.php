        ...
        <div class="mb-2">
			...
			<div class="mb-2">
                ...
                <select class="form-select form-select-sm data-network" aria-label="form-select-sm example" name="network">
					...
					<?php
					if(stripos(vp_option_array($option_array,"sme_visible_networks"),"mtn") !== false){
						?>
                    <option value="<?php echo vp_option_array($option_array,'datamtn');?>" class="smenetwork">MTN</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"sme_visible_networks"),"glo") !== false){
					?>
					<option value="<?php echo vp_option_array($option_array,'dataglo');?>" class="smenetwork">GLO</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"sme_visible_networks"),"airtel") !== false){
					?>
					<option value="<?php echo vp_option_array($option_array,'dataairtel');?>" class="smenetwork">AIRTEL</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"sme_visible_networks"),"9mobile") !== false){
					?>
					<option value="<?php echo vp_option_array($option_array,'data9mobile');?>" class="smenetwork">9MOBILE</option>
					<?php
					}
					?>
					</div>
					...
					<?php
					if(stripos(vp_option_array($option_array,"corporate_visible_networks"),"mtn") !== false){
						?>
                    <option value="<?php echo vp_option_array($option_array,'r2datamtn');?>" class="corporatenetwork">MTN</option>
					<?
					}
					if(stripos(vp_option_array($option_array,"corporate_visible_networks"),"glo") !== false){
						?>
					<option value="<?php echo vp_option_array($option_array,'r2dataglo');?>" class="corporatenetwork">GLO</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"corporate_visible_networks"),"airtel") !== false){
						?>
					<option value="<?php echo vp_option_array($option_array,'r2dataairtel');?>" class="corporatenetwork">AIRTEL</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"corporate_visible_networks"),"9mobile") !== false){
						?>
					<option value="<?php echo vp_option_array($option_array,'r2data9mobile');?>" class="corporatenetwork">9MOBILE</option>
					<?php
					}
					?>
					</div>
					...
					<?php
					if(stripos(vp_option_array($option_array,"direct_visible_networks"),"mtn") !== false){
						?>
                    <option value="<?php echo vp_option_array($option_array,'rdatamtn');?>" class="directnetwork">MTN</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"direct_visible_networks"),"glo") !== false){
					?>
					<option value="<?php echo vp_option_array($option_array,'rdataglo');?>" class="directnetwork">GLO</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"direct_visible_networks"),"airtel") !== false){
					?>
					<option value="<?php echo vp_option_array($option_array,'rdataairtel');?>" class="directnetwork">AIRTEL</option>
					<?php
					}
					if(stripos(vp_option_array($option_array,"direct_visible_networks"),"9mobile") !== false){
					?>
					<option value="<?php echo vp_option_array($option_array,'rdata9mobile');?>" class="directnetwork">9MOBILE</option>
					<?php
					}
					?>
					</div>
...
<?php
	...
	if(datachoice == "sme"){
		jQuery(".data-network").val("none");
		jQuery(".data-plan").val("none");
		jQuery(".data-network *").hide();
		jQuery(".data-network .smenetwork").show();
		jQuery(".datatcode").val(jQuery(".datachoice").val());
	}
	else if(datachoice == "corporate"){
		jQuery(".data-network").val("none");
		...
		jQuery(".data-plan").val("none");
		jQuery(".data-network *").hide();
		jQuery(".directnetwork").show();
		jQuery(".datatcode").val(jQuery(".datachoice").val());
	}
	else if(datachoice == "none"){
		jQuery(".data-network").val("none");
		jQuery(".data-plan").val("none");
		jQuery(".data-network *").hide();
		jQuery(".datatcode").val(jQuery(".datachoice").val());
	...
	/*End of default runtime 
	#and beginning of datachoice changes... PHP run it
	*/
...
?>
	...
	break;
	default:alert("Error CODE myDATA --- Under crst VP CUST");
}
...
break;
case "0706":
if(data_network_text == "MTN" || data_network_text == "GLO"){
...
default: jQuery("input.data-phone").addClass("is-invalid");
    ...
    if(data_phone_length != "11" && data_phone_length != "0" ){
