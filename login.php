...
<html lang="en"
  class="wf-flaticon-n4-inactive wf-fontawesome5solid-n4-active wf-fontawesome5regular-n4-active wf-fontawesome5brands-n4-active wf-simplelineicons-n4-active wf-lato-n7-active wf-lato-n9-active wf-lato-n4-active wf-lato-n3-active wf-active">
...
<head>
  ...
  <meta itemprop="name"
    content="<?php echo get_bloginfo("name"); ?> - Buy Airtime and Data for all Network. Make payment for DSTV, GOTV, PHCN other services">
  ...
  <link rel="stylesheet" href="<?php echo plugins_url('msorg_template'); ?>/login_files/css" media="all">
  <link rel="stylesheet" href="<?php echo plugins_url('msorg_template'); ?>/login_files/fonts.min.css" media="all">
  <!-- CSS Files -->
...
<body class="login">
  <style>
    ...
    .btn-primary:disabled {
      background:
        <?php echo vp_getoption("msorg_from"); ?>
        !important;
    ...
    <div class="container container-login animated fadeIn" style="display: block;">
      ...
      <div class="text-center">
        ...
        <div class="logo-top mb-4" style="#99999961;">
          <a href="<?php echo home_url(); ?>"><img
              src="<?php echo get_site_icon_url(75, vp_option_array($option_array, 'siteurl') . '/wp-content/plugins/msorg_template/msorg_template/vlogo.png'); ?>"
              alt="" style="height:75px; width:75px;" /></a>
        </div>
      ...
      <form method="POST" class="loginit">
        <input type="hidden" name="csrfmiddlewaretoken"
          value="3xy69wg7BU4aa2o3pb58S7JfTAwCTYO1tQnUvja3Joncym56zB42btt6VN6MUJTu">
        <div class="form-group">
          ...
          <div id="div_id_username" class="form-group">
            ...
            <div class="">
              <input type="text" name="username" autofocus="" id="username" autocapitalize="none"
          ...
          <div id="div_id_password" class="form-group">
            ...
            <div class="">
              <input type="password" name="password" id="password" autocomplete="current-password"
                class="textinput textInput form-control" required="" id="password">
  ...
  <!-- Include file path to the script.php of the fingerprint plugin -->
  <?php
  include_once(plugin_dir_path(__FILE__) . '../vtupress/fingerprint/script.php');
  ?>
