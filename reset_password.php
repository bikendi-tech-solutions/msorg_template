...
<html lang="en" class="wf-flaticon-n4-inactive wf-fontawesome5solid-n4-active wf-fontawesome5regular-n4-active wf-fontawesome5brands-n4-active wf-simplelineicons-n4-active wf-lato-n7-active wf-lato-n9-active wf-lato-n4-active wf-lato-n3-active wf-active"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Reset Password - <?php echo get_bloginfo("name");?> | Buy Data, Airtime to cash, Bills Payment</title>
...
<div id="div_id_username" class="form-group">
        ...
        <label for="id_username" class=" requiredField">
            ...
            <div class="">
                <input type="text" name="username" autofocus="" id="username" autocapitalize="none" autocomplete="username" maxlength="150" class="textinput textInput form-control username" required="" id="id_username">
...
<div id="div_id_email" class="form-group">
        ...
        <label for="id_email" class=" requiredField">
            ...
            <div class="">
                <input type="text" name="email" autofocus="" id="email" autocapitalize="none" autocomplete="email" maxlength="150" class="textinput textInput form-control email" required="" id="id_email">
...
<div id="div_id_pin" class="form-group">
    ...
    <div id="div_id_password" class="form-group">
          ...
          <a href="?login" class="link float-right">Already Have An Account ?</a>
            ...
            <button type="button" class="btn btn-primary  mt-3 mt-sm-0 fw-bold first-level-signin" id="loginow">Reset</button>
          </div>
...
jQuery(".first-level-signin").text("Please Wait");
var obj = {};
  ...
  error: function (jqXHR, exception) {
	  console.log(jqXHR);
       console.log(exception);
		jQuery(".first-level-signin").text("Reset");
        var msg = "";
        if (jqXHR.status === 0) {
            msg = "No Connection.\n Verify Network.";
     swal({
