...
<html lang="en" class="wf-flaticon-n4-inactive wf-fontawesome5solid-n4-active wf-fontawesome5regular-n4-active wf-fontawesome5brands-n4-active wf-simplelineicons-n4-active wf-lato-n7-active wf-lato-n9-active wf-lato-n4-active wf-lato-n3-active wf-active"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Activate - <?php echo get_bloginfo("name");?> | Buy Data, Airtime to cash, Bills Payment</title>
  ...
  <div class="wrapper wrapper-login">
    ...
    <div class="container container-login animated fadeIn" style="display: block;">
      ...
      <form method="POST" class="loginit">
        ...
        <div class="form-group activation-form">
...
<div id="div_id_username" class="form-group">
        ...
        <label for="id_username" class=" requiredField">
            ...
            <div class="">
                <input type="text" name="user" autofocus="" id="username" autocapitalize="none" autocomplete="username" maxlength="150" class="textinput textInput form-control username" required="" id="id_username">
...
<div id="div_id_activate" class="form-group">
        
        <label for="id_activate" class=" requiredField">
            Activation Code<span class="asteriskField">*</span>
        </label>
        
            <div class="">
                <input type="text" name="verify" autofocus="" id="activate" autocapitalize="none" autocomplete="activate" maxlength="150" class="textinput textInput form-control activate" required="" id="id_activate">
          ...
          <a href="?login" class="link float-right">Already Have An Account ?</a>

            <button type="button" class="btn btn-primary  mt-3 mt-sm-0 fw-bold activate-now" id="">Activate Now</button>
          </div>
  ...
  error: function (jqXHR, exception) {
	  console.log(jqXHR);
       console.log(exception);
		jQuery(".activate-now").text("Activate Now");
        var msg = "";
        if (jqXHR.status === 0) {
            msg = "No Connection.\n Verify Network.";
     swal({
