...
<div class="bg bg-white p-3 overflow-auto mx-3 ">
		<table class="d-flex justify-content-md-center table table-responsive table-hover history-successful h6 font-size h6 font-size">
		<tbody>
		';
            ...
            <div class="modal fade" id="dataexampleModal'.$resultsd->id.'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
						<div class="container-fluid border border-secondary" id="datareceipt'.$resultsd->id.'">
								<div class="row bg bg-dark text-white">
									<div class="col bg bg-dark text-white">
										<span class=""><h3>@INVOICE</h3></span>
									</div>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary  p-2 text-xs font-bold text-black uppercase bg-grey-600 rounded shadow   data-proceed-cancled" data-bs-dismiss="modal">Cancel</button>
					  <button type="button" id="" class="btn btn-info  p-2 text-xs font-bold text-white uppercase bg-blue-600 rounded shadow  "  onclick="printContent(\'datareceipt'.$resultsd->id.'\');">Print</button>
            ...
            <div class="modal fade" id="betexampleModal'.$resultsd->id.'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
						<div class="container-fluid border border-secondary" id="betreceipt'.$resultsd->id.'">
								<div class="row bg bg-dark text-white">
									<div class="col bg bg-dark text-white">
										<span class=""><h3>@INVOICE</h3></span>
									</div>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary  p-2 text-xs font-bold text-black uppercase bg-grey-600 rounded shadow   bet-proceed-cancled" data-bs-dismiss="modal">Cancel</button>
					  <button type="button" id="" class="btn btn-info  p-2 text-xs font-bold text-white uppercase bg-blue-600 rounded shadow  "  onclick="printContent(\'betreceipt'.$resultsd->id.'\');">Print</button>
...
echo'
	...
	<!--SERVICE NAME-->
		...
		echo'
		<div class="bg bg-white p-3 overflow-auto mx-3 ">
		<table class="d-flex justify-content-md-center table table-responsive table-hover history-successful h6 font-size">
		<tbody>
		';
		/*
global $wpdb;
...
echo'
<div class="bg bg-white p-3 overflow-auto mx-3 ">
<table class="d-flex justify-content-md-center table table-responsive table-hover withdraw-history-table">
		<tbody>
		';
