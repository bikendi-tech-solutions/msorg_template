	...
	if (strtolower($level[0]->developer) == "yes") {
		...
		<div class="col">
			...
			<div class="mb-3">
				...
				Response [JSON]:
				{"Status":"100","Successful":"true","Id":"20","Plan":"reseller","Balance":"13372","Referred_By":"0"}<br>
			...
			<div class="mb-3">
				...
				<table>
					<tbody>
						...
						<br>
						Example:
						<?php echo esc_url(plugins_url('vprest/?q=airtime&id=' . $id . '&apikey=' . $apikey . '&phone=07049626922&amount=200&network=mtn&type=sme')); ?><br>
				...
				<div class="mb-3 mt-3">
					...
					<table>
						<tbody>
							...
							<br>
							Example:
							<?php echo esc_url(plugins_url('vprest/?id=1&apikey=165c66r&q=smile&type=id&plan_id=767&recipient=2209002222')); ?><br>
			...
			<div class="mb-3 mt-3">
				...
				<table>
					<tbody>
						...
						<br>
						Example:
						<?php echo esc_url(plugins_url('vprest/?id=1&apikey=234&q=data&phone=07049626922&network=mtn&type=sme&dataplan=1')); ?><br>
		...
		if (is_plugin_active("vprest/vprest.php") && vp_getoption("cardscontrol") == "checked") {
			...
			<div class="col my-2 shadow rounded p-3">
				...
				Example :
				<?php echo esc_url(plugins_url('vprest/?q=recharge_card&id=' . $id . '&apikey=' . $apikey . '&quantity=2&network=mtn&denomination=100')); ?><br>
		...
		if (is_plugin_active("vprest/vprest.php") && vp_getoption("datascontrol") == "checked") {
			...
			<div class="col my-2 shadow rounded p-3">
				...
				Example :
				<?php echo esc_url(plugins_url('vprest/?q=data_card&id=' . $id . '&apikey=' . $apikey . '&quantity=2&dataplan=1')); ?><br>
		...
		if (is_plugin_active("vprest/vprest.php") && vp_getoption("setcable") == "checked" && is_plugin_active("bcmv/bcmv.php")) {
			...
			<div class="col my-2 shadow rounded p-3">
				...
				Example:
				<?php echo esc_url(plugins_url('vprest/?q=cable&id=' . $id . '&apikey=' . $apikey . '')); ?>&type=gotv&iuc=1212121212&plan=1<br>
		...
		if (is_plugin_active("vprest/vprest.php") && vp_getoption("setbill") == "checked" && is_plugin_active("bcmv/bcmv.php")) {
			...
			<div class="col my-2 shadow rounded p-3">
				...
				Example:
				<?php echo esc_url(plugins_url('vprest/?q=bill&id=' . $id . '&apikey=' . $apikey . '')); ?>&type=prepaid&meter_number=1212121212&plan=1&amount=10000<br>
