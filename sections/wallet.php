  ...
  if (vp_getoption('enable_monnify') == "yes" || vp_getoption('enable_ncwallet') == "yes" || vp_getoption('enable_payvessel') == "yes" || vp_getoption('enable_billstack') == "yes" || vp_getoption('enable_nomba') == "yes" || vp_getoption('enable_paymentpoint') == "yes" || vp_getoption('enablesquadco') == "yes" || vp_getoption('enablevpay') == "yes" || vp_getoption('enablekuda') == "yes" && ($bvn != 'false' || $nin != 'false' || vp_getoption('enablevpay') == "yes") && (!empty($bvn) || !empty($nin) || vp_getoption('enablevpay') == "yes") && (mb_strlen($bvn) > 10 || vp_getoption('enablevpay') == "yes")) {
    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
      <div class="accordion-item <?php echo accordion_main("auto"); ?> ">
        ...
        <div id="flush-collapseZero" class="accordion-collapse <?php echo accordion_sub("auto"); ?> "
            ...
            <div class="card">
              ...
              <ul class="nav nav-tabs" role="tablist">
                <?php if (vp_getoption('enablesquadco') == "yes" && vp_getoption("vtupress_custom_gtbank") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#squad" role="tab"><span
                ...
                if (vp_getoption('enablevpay') == "yes" && vp_getoption("vtupress_custom_vpay") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#vpay" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enable_ncwallet') == "yes" && vp_getoption("vtupress_custom_ncwallet") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#ncwallet" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enable_payvessel') == "yes" && vp_getoption("vtupress_custom_payvessel") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#payvessel" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enable_paymentpoint') == "yes" && vp_getoption("vtupress_custom_paymentpoint") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#paymentpoint" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enable_nomba') == "yes" && vp_getoption("vtupress_custom_nomba") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#nomba" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enable_billstack') == "yes" && vp_getoption("vtupress_custom_billstack") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#billstack" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enablekuda') == "yes" && vp_getoption("vtupress_custom_kuda") == "yes") {
                  ...
                  <li class="nav-item">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#kuda" role="tab"><span
                        class="hidden-sm-up"></span>
                ...
                if (vp_getoption('enable_monnify') == "yes") { ?>
                  <li
                    class="nav-item <?php if (preg_match("/null/i", $bank_name2) && (!empty($bank_name1) || !empty($bank_name))) {
                      echo "d-none";
                    } ?>">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#home" role="tab"><span
                        class="hidden-sm-up"></span>
                      <span class="hidden-xs-down"><?php echo $bank_name2; ?></span></a>
                  </li>
                  <li
                    class="nav-item  <?php if (preg_match("/null/i", $bank_name1) && (!empty($bank_name2) || !empty($bank_name))) {
                      echo "d-none";
                    } ?>">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#profile" role="tab"><span
                        class="hidden-sm-up"></span>
                      <span class="hidden-xs-down"><?php echo $bank_name1; ?></span></a>
                  </li>
                  <li
                    class="nav-item  <?php if (preg_match("/null/i", $bank_name) && (!empty($bank_name1) || !empty($bank_name2))) {
                      echo "d-none";
                    } ?>">
                    <a class="nav-link <?php echo banksbtn(); ?>" data-bs-toggle="tab" href="#messages" role="tab"><span
                        class="hidden-sm-up"></span>
              ...
              <div class="tab-content tabcontent-border">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($squadAccountNumber, "gtb"); ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($vpayAccountNumber, "vpay"); ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($ncwallet_accountnumber, "ncwallet"); ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($payvessel_accountnumber, "payvessel"); ?>
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <div class="col Name white  text-center">
                            <p>
                              <?php echo $payvessel_accountname; ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($billstack_accountnumber, "billstack"); ?>
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <div class="col Name white  text-center">
                            <p>
                              <?php echo $billstack_accountname; ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($paymentpoint_accountnumber, "paymentpoint"); ?>
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <div class="col Name white  text-center">
                            <p>
                              <?php echo $paymentpoint_accountname; ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($nomba_accountnumber, "nomba"); ?>
                            </p>
                          </div>
                        </div>
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($kudaAccountNumber, "kuda"); ?>
                            </p>
                          </div>
                        </div>
                ...
                if (vp_getoption('enable_monnify') == "yes") { ?>
                  ...
                  <div class="tab-pane <?php echo (is_numeric($account_number2)) ? banksmodal() : ""; ?>" id="home"
                    role="tabpanel">
                    <div class="p-md-20">
                ...
                <div class="Wrap mb-2 cdebit-card   position-relative">
                  ...
                  <div class="tab-pane <?php echo (is_numeric($account_number1)) ? banksmodal() : ""; ?>" id="profile"
                    role="tabpanel">
                    <div class="p-md-20">
                ...
                <div class="Wrap mb-2 cdebit-card   position-relative">
                  ...
                  <div class="tab-pane <?php echo (is_numeric($account_number)) ? banksmodal() : ""; ?>" id="messages"
                    role="tabpanel">
                    <div class="p-md-20">
                    ...
                    <div class="Inner-wrap">
                      ...
                      <div class=" container text-white p-4 roundeds">
                        ...
                        <div class="row mb-3">
                          <div class="col card-number text-center">
                            <p>
                              <?php accountNumber($account_number, "monnify"); ?>
                            </p>
                          </div>
                        </div>
                ...
                <!------------------>
                  ...
                  <div
                    class="tab-pane <?php echo (is_numeric($account_number2) || is_numeric($account_number1) || is_numeric($account_number)) ? "d-none" : " show active"; ?>"
  ...
  if (vp_getoption("allow_card_method") == "yes") {
    ?>
      ...
      <div class="accordion-item <?php echo accordion_main("card"); ?>">
        ...
        <div id="flush-collapseOne" class="accordion-collapse <?php echo accordion_sub("card"); ?> "
  ...
  if (vp_option_array($option_array, "vtupress_custom_auto_manual") == "yes" && vp_option_array($option_array, "enable_auto_manual") == "yes"):
    ?>
      ...
      <div class="accordion-item <?php echo accordion_main("manual"); ?>">
        ...
        <div id="flush-collapseTwo" class="accordion-collapse <?php echo accordion_sub("manual"); ?>"
          ...
          <div class="accordion-body dark-white">
              ...
              <?php for ($i = 1; $i <= 3; $i++):
                ...
                <div class="col-12 col-md-4 border d-flex justify-content-center flex-column align-items-center p-3">
                  ...
                  <h3><?php echo trim(vp_option_array($option_array, 'auto_manual_account_number' . $i)); ?>
                    <!--Copy-->
                    <i class="fas fa-copy copyAccount"
                      accountNumber="<?php echo trim(vp_option_array($option_array, 'auto_manual_account_number' . $i)); ?>"></i>
                  </h3>
                  <h4><?php echo trim(vp_option_array($option_array, 'auto_manual_account_name' . $i)); ?></h4>
                  <button class="madeTransfer btn btn-success rounded my-3"
                    accountNumber="<?php echo trim(vp_option_array($option_array, 'auto_manual_account_number' . $i)); ?>">I have
                    made payment</button>
                </div>
            ...
            <!--MODAL-->
            <div class="modal fade" id="betexampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
              aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button"
                      class="btn btn-secondary  p-2 text-xs font-bold text-black uppercase bg-grey-600 rounded shadow   bet-proceed-cancled"
      ...
      <div class="accordion-item <?php echo accordion_main("manual"); ?>">
        ...
        <div id="flush-collapseTwo" class="accordion-collapse <?php echo accordion_sub("manual"); ?>"
          ...
          <div class="accordion-body dark-white">
            ...
            <div style="text-align:center; background-color: #6c6cd426;">
              <?php echo vp_option_array($option_array, 'manual_funding'); ?></div>
  ...
  if (vp_option_array($option_array, "airtime_to_cash") == "yes" || vp_option_array($option_array, "airtime_to_wallet") == "yes" && vp_option_array($option_array, "resell") == "yes") {
    ?>
      <div class="accordion-item <?php echo accordion_main("airtime"); ?> ">
        ...
        <div id="flush-collapseThree" class="accordion-collapse <?php echo accordion_sub("airtime"); ?>"
            ...
            <div class="container-md mt-3">
              <div class="p-3" style="border: 1px solid grey; border-radius: 5px;">
                <div class="mb-2">
                  ...
                  <input type="number" name="transfer_from" class="transfer_from form-control" value=""
                  ...
                  <input type="button" name="convert_it" value="CONVERT"
                    class="form-control mt-2 convert_it w-full p-3 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow text-light btn btn-primary">
                </div>
  ...
  if (vp_option_array($option_array, "enable_coupon") == "yes" && vp_option_array($option_array, "resell") == "yes") {
    ?>
      <div class="accordion-item <?php echo accordion_main("coupon"); ?>">
        ...
        <div id="flush-collapseFour" class="accordion-collapse <?php echo accordion_sub("coupon"); ?>"
            ...
            <div class="container-md mt-3">
              <div class="p-3" style="border: 1px solid grey; border-radius: 5px;">
                <div class="mb-2">
                  ...
                  <input type="button" name="run_coupon" value="Redeem Code"
                    class="form-control run_coupon btn btn-secondary w-full p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow text-light">
                </div>
