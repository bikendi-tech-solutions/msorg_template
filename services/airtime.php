            ...
            <div class="mb-2">
                <form class="for" id="cfor" method="post" <?php echo apply_filters('formaction', 'target="_self"'); ?>>
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select form-select-sm airtime-network" aria-label="form-select-sm example"
                            id="net" name="network" onchange="makeChoice()">
                    ...
                    <div class="mb-2 ">
                        ...
                        <select id="airtimechoice" name="airtimechoice" class="airtime-choice form-select form-select-sm"
                            aria-label=".form-select-sm example" onchange="makeChoice()">
                    ...
                    <div class="mb-2 visually-hidden">
                        ...
                        <input type="text" name="vpname" class="form-control airtime-name" placeholder="Name"
                            aria-label="Name" aria-describedby="basic-addon1" value="<?php echo $data->user_login; ?>">
                    </div>
                    <div class="mb-2 visually-hidden">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" name="vpemail" class="form-control airtime-email" placeholder="Email"
                    ...
                    <div class="mb-2">
                        ...
                        <input id="phone" name="phone" list="beneficiaries" type="number"
                            class="form-control airtime-number airtime-phone" maxlength="11" placeholder="Phone Number"
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input id="amt" name="amount" type="number" class="form-control airtime-amount"
                                onchange="calcit();" placeholder="Amount" aria-label="Username"
                    ...
                    <div class="vstack gap-2">
                        ...
                        if (vp_option_array($option_array, "vpdebug") != "yes" || current_user_can("administrator")) {
                            ?>
                            <button type="button"
                                class="w-full p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow purchase-airtime btn"
                                data-bs-toggle="modal" data-bs-target="#exampleModal"
                                data-bs-whatever="@getbootstrap">Purchase</button>
                            <?php
                        } else {
                            ?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button"
                                    class="p-2 text-xs font-bold text-dark uppercase bg-gray-600 rounded shadow airtime-proceed-cancled btn-danger"
                                    data-bs-dismiss="modal">Cancel</button>
                                <button type="button" name="wallet" id="wallet"
                                    class=" p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow airtime-proceed btn-success"
