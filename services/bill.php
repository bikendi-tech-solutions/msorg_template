...
if(current_user_can("administrator")){
	?>
                <button type="button" class="btn btn-secondary text-white view-url">View Url</button>
<?php 
}
?>
			<?php
if(vp_option_array($option_array,"vpdebug") != "yes" || current_user_can("administrator")){
	?>
                    <button type="button" class="w-full p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow purchase-bill btn" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">Purchase</button>
           <?php
}
else{
  ?>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				if(is_plugin_active("vprest/vprest.php")  && vp_option_array($option_array,'resell') == "yes"){
                    ...
                    <div class="modal-footer">
                      <button type="button" class="p-2 text-xs font-bold text-white uppercase bg-gray-600 rounded shadow bill-proceed-cancled btn-danger" data-bs-dismiss="modal">Cancel</button>
                      <button type="button" name="wallet" id="wallet" class=" p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow bill-proceed btn-success" form="cfor">Proceed</button>
                    </div>
                  </div>
                </div>
            </div>
