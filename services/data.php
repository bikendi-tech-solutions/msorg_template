...
if (vp_option_array($option_array, "vprun") != "block") {
			...
			<div class="mb-2">
				...
				<form id="cfor" class="for" id="cfor" method="post" <?php echo apply_filters('formaction', 'target="_self"'); ?>>
					...
					<div class="mb-2">
						...
						<select class="form-select form-select-sm data-network" aria-label="form-select-sm example"
							name="network">
							...
							if (vp_getoption("alphacontrol") == "checked" && vp_getoption("vtupress_custom_smile") == "yes" && isset($_GET["alpha"])) {
								?>
								<option value="alpha" for="alphaNetwork" id="foralphaNetwork">ALPHA</option>
								<?php
							}
							?>
					...
					<div class="mb-2 dataTypeDiv">
						...
						<select id="datachoice" aria-label="form-select-sm example"
							class="form-select form-select-sm datachoice" name="datachoice">
					...
					<div class="mb-2 d-data">
						...
						<select class="form-select form-select-sm data-plan" aria-label="form-select-sm example"
							name="cplan" id="cdat">
							<option value="none">---Select---</option>
							...
							<div class="alpha_data_plan">
								<?php
								for ($i = 0; $i <= 10; $i++) {
									$doos = vp_option_array($option_array, "calphadata" . $i);
									if ($doos != "") {
										echo '<option value="' . vp_option_array($option_array, "calphadata" . $i) . '" id="' . $i . '" class="alphadata alphadataplan">' . vp_option_array($option_array, "calphadatan" . $i) . ' ' . $symbol . vp_option_array($option_array, "calphadatap" . $i) . '</option>';
									}
								}
								?>
							</div>
					...
					<div class="mb-2 visually-hidden">
						...
						<input type="text" name="vpname" class="form-control data-name" placeholder="Name" aria-label="Name"
							aria-describedby="basic-addon1" value="<?php echo $data->user_login; ?>">
					</div>
					<div class="mb-2 visually-hidden">
						<label for="email" class="form-label">Email</label>
						<input type="email" name="vpemail" class="form-control data-email" placeholder="Email"
							aria-label="Email" aria-describedby="basic-addon1" value="<?php echo $data->user_email; ?>">
					</div>
					<div class="mb-2 visually-hidden">
						...
						<input type="hidden" id="url1" name="url1"
							value="<?php echo esc_url(plugins_url('vtupress/process.php')); ?>">
					...
					<div class="mb-2 phoneDiv">
						...
						<input id="phone" name="phone" list="beneficiaries" type="number"
							class="form-control data-number data-phone" maxlength="11" placeholder="Phone Number"
						...
						<div class="mb-2 smileReqs mb-2">
							<div class="d-flex justify-content-end ">
								<span
									class="btn btn-primary verify-email btn-sm p-2 d-flex align-items-center justify-content-center"
									style="width:100px;height:25px;">Verify</span>
					...
					<div class="mb-2">
						...
						<div class="input-group mb-2">
							...
							<input type="number" class="form-control data-amount" placeholder="Amount" aria-label="Amount"
								aria-describedby="basic-addon1" id="amt" name="amount" readonly>
					...
					if (is_plugin_active("vprest/vprest.php") && vp_option_array($option_array, 'resell') == "yes") {
						...
						<div class="mb-2">
							...
							<div class="input-group mb-2">
								<span class="input-group-text" id="basic-addon1"><?php echo $currency; ?>.</span>
								<input id="amttopay" type="number" class="form-control amttopay" max="<?php echo $bal; ?>"
									placeholder="Amount To Pay" aria-label="Username" aria-describedby="basic-addon1" readonly>
								<span class="input-group-text" id="basic-addon1">.00</span>
								<div id="validationServer04Feedback" class="invalid-feedback">
					...
					<div class="vstack gap-2">
						...
						if (current_user_can("administrator")) {
							?>
							<button type="button" class="btn btn-secondary view-url text-white">View Url</button>
							<?php
						}
						?>
						<?php
						if (vp_option_array($option_array, "vpdebug") != "yes" || current_user_can("administrator")) {
							?>
							<button type="button"
								class="w-full p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow purchase-data btn"
								data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap"
								id="btnsubmit">Purchase</button>
							<?php
						} else {
							?>
							<button onclick="alert('Currently Under Maintainance. Please Try Again Later.');" type="button"
								class="w-full p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow on-dev btn btn-info">Under
								Development</button>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button"
									class="p-2 text-xs font-bold text-white uppercase bg-gray-600 rounded shadow data-proceed-cancled btn-danger"
									data-bs-dismiss="modal">Cancel</button>
								<button type="button" name="wallet" id="wallet"
									class=" p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow data-proceed btn-success"
									form="cfor">Proceed</button>
							</div>
						</div>
					</div>
				</div>
				...
				<script type="text/javascript">
					...
					jQuery(document).ready(function () {
						...
						jQuery(".data-network").on("change", function () {
							...
							switch (network_value) {
								case "<?php echo $mtn; ?>":
									...
									if ("<?php if (preg_match("/mtn|$mtn/i", vp_option_array($option_array, "sme_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/mtn|$mtn/i", vp_option_array($option_array, "corporate_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/mtn|$mtn/i", vp_option_array($option_array, "direct_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
								...
								case "<?php echo $glo; ?>":
									...
									jQuery(".dataTypeDiv").show();
									jQuery(".smileReqs").hide();
									if ("<?php if (preg_match("/glo|$glo/i", vp_option_array($option_array, "sme_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/glo|$glo/i", vp_option_array($option_array, "corporate_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/glo|$glo/i", vp_option_array($option_array, "direct_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									break;
								case "<?php echo $mobile; ?>":
									jQuery(".phoneDiv").show();
									jQuery("input.data-number").val("");
									jQuery(".purchase-data").show();
									jQuery(".dataTypeDiv").show();
									jQuery(".smileReqs").hide();
									if ("<?php if (preg_match("/9mobile|$mobile/i", vp_option_array($option_array, "sme_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/9mobile|$mobile/i", vp_option_array($option_array, "corporate_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/9mobile|$mobile/i", vp_option_array($option_array, "direct_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									break;
								case "<?php echo $airtel; ?>":
									jQuery(".phoneDiv").show();
									jQuery("input.data-number").val("");
									jQuery(".purchase-data").show();
									jQuery(".dataTypeDiv").show();
									jQuery(".smileReqs").hide();
									if ("<?php if (preg_match("/airtel|$airtel/i", vp_option_array($option_array, "sme_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/airtel|$airtel/i", vp_option_array($option_array, "corporate_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
									...
									if ("<?php if (preg_match("/airtel|$airtel/i", vp_option_array($option_array, "direct_visible_networks"))) {
										echo "true";
									} else {
										echo "false";
									} ?>" == "true") {
						...
						function networktoplan() {
							...
							if (d2atachoice == "sme" && d2atanetwork == "<?php echo $mtn; ?>") {
								...
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "sme" && d2atanetwork == "<?php echo $glo; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .smiledata").hide();
							...
							else if (d2atachoice == "sme" && d2atanetwork == "<?php echo $mobile; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "sme" && d2atanetwork == "<?php echo $airtel; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "corporate" && d2atanetwork == "<?php echo $mtn; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "corporate" && d2atanetwork == "<?php echo $glo; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "corporate" && d2atanetwork == "<?php echo $mobile; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "corporate" && d2atanetwork == "<?php echo $airtel; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "direct" && d2atanetwork == "<?php echo $mtn; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "direct" && d2atanetwork == "<?php echo $glo; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "direct" && d2atanetwork == "<?php echo $mobile; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atachoice == "direct" && d2atanetwork == "<?php echo $airtel; ?>") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata").hide();
							...
							else if (d2atanetwork == "ALPHA") {
								jQuery(".data-plan .smedataplan").hide();
								jQuery(".data-plan .corporatedataplan").hide();
								jQuery(".data-plan .directdataplan").hide();
								jQuery(".data-plan .alphadata.alphadataplan").show();
								jQuery(".data-plan .smiledata").hide();
								jQuery(".check-balance").text("ALPHA");
								jQuery(".check-balance").css({ "background-color": "#dc3545", "color": "white" });
							...
							//	alert(d2atachoice." ".d2atanetwork);
	...
	'; ?>
								...
								<?php
								echo '
	url.val("alphabase' . vp_option_array($option_array, "alphaendpoint") . "alphapostdata1" . '=' . "alphapostvalue1" . '&' . vp_option_array($option_array, "request_id") . '="+request_id+"&' . "alphapostdata2" . '=' . "alphapostvalue2" . '&' . vp_option_array($option_array, "alphapostdata3") . '=' . vp_option_array($option_array, "alphapostvalue3") . '&' . vp_option_array($option_array, "alphapostdata4") . '=' . vp_option_array($option_array, "alphapostvalue4") . '&' . vp_option_array($option_array, "alphapostdata5") . '=' . vp_option_array($option_array, "alphapostvalue5") . '&' . vp_option_array($option_array, "alphanetworkattribute") . '="+accountId+"&' . vp_option_array($option_array, "alphaamountattribute") . '="+amount+"&' . vp_option_array($option_array, "alphaphoneattribute") . '="+phone+"&' . vp_option_array($option_array, "alphavariationattr") . '="+cdat2+"&datacode="+datacode);
	'; ?>
							}
							else {
						...
						var phone = jQuery("input.data-number").val();
						//the phone number value
						var phoneslice = phone.slice(0, 4);
						//check from 0 to 4th character of phone
						var data_network_value = jQuery("select.data-network").val();
						//check the network value
						var data_network_text = jQuery("select.data-network option:selected").text();
						//check the network text
						var data_plan_text = jQuery("select.data-plan option:selected").text();
						//check the plan text
						var data_phone_length = jQuery("input.data-number").val().length;
						//check the length of the phone number field
						...
						if (data_phone_length == "11" || datachoice.toLowerCase() == "smile" || datachoice.toLowerCase() == "alpha") {
							...
							if (jQuery('input.bypass').is(':checked') == true) {
								...
								switch (phoneslice) {
									case "0702":
										if (data_network_text == "<?php echo $mtn; ?>" || data_network_text == "SMILE" || data_network_text == "ALPHA") {
									...
									case "0704":
										...
										break;
									case "0706":
										if (data_network_text == "<?php echo $mtn; ?>" || data_network_text == "<?php echo $glo; ?>" || data_network_text == "SMILE" || data_network_text == "ALPHA") {
									...
									case "0916":
										...
										break;
									case "0701":
										if (data_network_text == "<?php echo $airtel; ?>" || data_network_text == "SMILE" || data_network_text == "ALPHA") {
									...
									case "0912":
										...
										break;
									case "0705":
										if (data_network_text == "<?php echo $glo; ?>" || data_network_text == "SMILE" || data_network_text == "ALPHA") {
									...
									case "0915":
										...
										break;
									case "0703":
										if (data_network_text == "<?php echo $mobile; ?>" || data_network_text == "SMILE" || data_network_text == "ALPHA") {
									...
									default: if (data_network_text == "SMILE" || data_network_text == "ALPHA") {
	...
	'; ?>
								...
								<?php
								echo '
	url.val("alphabase' . vp_option_array($option_array, "alphaendpoint") . "alphapostdata1" . '=' . "alphapostvalue1" . '&' . vp_option_array($option_array, "request_id") . '="+request_id+"&' . "alphapostdata2" . '=' . "alphapostvalue2" . '&' . vp_option_array($option_array, "alphapostdata3") . '=' . vp_option_array($option_array, "alphapostvalue3") . '&' . vp_option_array($option_array, "alphapostdata4") . '=' . vp_option_array($option_array, "alphapostvalue4") . '&' . vp_option_array($option_array, "alphapostdata5") . '=' . vp_option_array($option_array, "alphapostvalue5") . '&' . vp_option_array($option_array, "alphanetworkattribute") . '="+network+"&' . vp_option_array($option_array, "alphaamountattribute") . '="+amount+"&' . vp_option_array($option_array, "alphaphoneattribute") . '="+phone+"&' . vp_option_array($option_array, "alphavariationattr") . '="+cdat2+"&datacode="+datacode);
	'; ?>
							}
							else {
								alert("Network / Plan choice error");
					...
					jQuery(".datachoice").on("change", function ($) {
						var data_network_text = jQuery("select.data-network option:selected").text();
						if (data_network_text == "<?php echo $mtn; ?>") {
							jQuery(".d-data").show();
						...
						if (data_network_text == "<?php echo $glo; ?>") {
							jQuery(".d-data").show();
						...
						if (data_network_text == "<?php echo $mobile; ?>") {
							jQuery(".d-data").show();
							jQuery("option.imtn").hide();
							jQuery("option.iairtel").hide();
						...
						if (data_network_text == "<?php echo $airtel; ?>") {
							jQuery(".d-data").show();
							jQuery("option.imtn").hide();
						...
						if (data_network_text == "SMILE") {
							...
							jQuery("option.i9mobile").hide();
							jQuery("option.iglo").hide();
							jQuery("option.alphadata").hide();
							jQuery("option.smiledata").show();
						}

						if (data_network_text == "ALPHA") {
							jQuery(".d-data").show();
							jQuery("option.imtn").hide();
							jQuery("option.iairtel").hide();
							jQuery("option.i9mobile").hide();
							jQuery("option.iglo").hide();
							jQuery("option.smiledata").hide();
							jQuery("option.alphadata").show();
						}
	...
	if(datachoice == "sme"){
		...
		switch(cdat){
			case "' . vp_option_array($option_array, "calphadata0") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap0") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata1") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap1") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata2") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap2") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata3") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap3") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata4") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap4") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata5") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap5") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata6") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap6") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata7") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap7") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata8") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap8") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata9") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap9") . '";
			break;
			case "' . vp_option_array($option_array, "calphadata10") . '":
			amtd.value = "' . vp_option_array($option_array, "calphadatap10") . '";
			break;
	...
	'; ?>
					...
					if (isset($_GET["smile"])) {
						?>
						jQuery(document).ready(function () {
							jQuery(".data-network").val("smile");
							jQuery(".data-network").change();
						});
					...
					if (isset($_GET["id"])) {
						$did = $_GET["id"];
						global $wpdb;
						$service_table = $wpdb->prefix . "sdata";
						$serviceRun = $wpdb->get_results("SELECT * FROM $service_table WHERE id = '$did ' ");

						if ($serviceRun !== NULL && !empty($serviceRun)) {
							$phoneIs = $serviceRun[0]->phone;
							?>

							jQuery(".data-phone").val("<?php echo $phoneIs; ?>");
	...
	'; ?>
						...
						if (obj["network_name"] == "SMILE") {
							...
							obj["smile_datatype"] = jQuery(".smile_account_type").val();
						}
						else if (obj["network_name"] == "ALPHA") {
							jQuery(".datatcode").val("alpha");
							obj["datatcode"] = jQuery("#datatcode").val();
						...
						//obj["smile_account_type"] = jQuery(".smile_account_type").val();
						obj["url"] = durl;
