            ...
            <div class="mb-2 d-data">
                    ...
                    <select class="form-select form-select-sm data-plan" aria-label="form-select-sm example" name="cplan" id="cdat">
						...
						for($i=0; $i<=10; $i++){
							...
							if($doos != "" ){
								echo '<option value="'.vp_option_array($option_array,"calphadata".$i).'" id="'.$i.'" class="alphadata alphadataplan">'.vp_option_array($option_array,"calphadatan".$i).' ₦'.vp_option_array($option_array,"calphadatap".$i).'</option>';
							}
							}
						?>
						</div>
...
if(vp_option_array($option_array,"vpdebug") != "yes" ||  current_user_can("administrator")){
	?>
                    <button type="button" class="w-full p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow purchase-data btn" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap" id="btnsubmit">Purchase</button>
   <?php
}
else{
    ?>
...
?>   
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				if(is_plugin_active("vprest/vprest.php")  && vp_option_array($option_array,'resell') == "yes"){
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" name="wallet" id="wallet" class=" p-2 text-xs font-bold text-white uppercase bg-indigo-600 rounded shadow data-proceed btn-success" form="cfor">Proceed</button>
                    </div>
                  </div>
                </div>
            </div>
	...
	switch (phoneslice){
	case "0702"://MTN
	if(data_network_text == "MTN" || data_network_text == "SMILE"   || data_network_text == "ALPHA" ){
	...
	break;
	case "0706":
	if(data_network_text == "MTN" || data_network_text == "GLO" || data_network_text == "SMILE"   || data_network_text == "ALPHA" ){
	...
	if(data_network_text == "AIRTEL" || data_network_text == "SMILE"   || data_network_text == "ALPHA" ){
	...
	if(data_network_text == "GLO" || data_network_text == "SMILE"   || data_network_text == "ALPHA" ){
	...
	if(data_network_text == "9MOBILE" || data_network_text == "SMILE"   || data_network_text == "ALPHA" ){
